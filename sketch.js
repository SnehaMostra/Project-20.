...
function preload() {
    ...
    catImg2and3 =loadAnimation("tomThree.png","tomTwo.png");
    catImg4 =loadImage("tomFour.png");
    bg =loadImage("garden.png");
    mImg1 =loadAnimation("jerryOne.png");
    mImg2 =loadAnimation("jerryTwo.png","jerryThree.png");
    mImg3 =loadAnimation("jerryFour.png");
}
